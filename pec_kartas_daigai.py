...
class Learn_forest:
    ...
    def forest_animal_image():
        # for animal in os.listdir('meza_dzivnieki'):
        ...
        translated_lv = GoogleTranslator(
            source='auto', target='lv').translate(animal_file_name)
        translated_lt = GoogleTranslator(
            source='auto', target='lt').translate(animal_file_name)
        translated_lv = str(translated_lv)
        translated_lt = str(translated_lt)
        translated_an_lv = f_font.render(translated_lv, True, white)
        translated_an_lt = f_font.render(translated_lt, True, white)
        translated_an_lv = screen.blit(translated_an_lv, (450, 500))
        translated_an_lt = screen.blit(translated_an_lt, (450, 550))
        read_translated_animal = Read_loud.say(f'This is {animal_file_name}.')

        return animal_image, f_text, translated_an_lv, translated_an_lt, read_translated_animal
...
class Main:
    ...
    def main_background(self):
        ...
        self.learn_forest_button = Button(
            300, 250, learn_forest_image, 1).draw()
        self.learn_forest1_button = Button(
            300, 350, learn_forest_image1, 1).draw()
